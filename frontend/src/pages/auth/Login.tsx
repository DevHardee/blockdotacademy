      ...
      <div className="relative min-h-screen bg-[#030303] flex items-center md:items-start md:pt-20 justify-center p-4 overflow-hidden">
        ...
        >
          ...
          <div className="bg-white/5 border border-white/10 backdrop-blur-2xl rounded-[32px] p-8 md:p-12 shadow-2xl relative overflow-hidden group">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-40 h-px bg-linear-to-r from-transparent via-primary/50 to-transparent" />
            ...
            <div className="text-center mb-10">
              ...
              >
                Welcome <span className="bg-linear-to-r from-primary to-accent bg-clip-text text-transparent italic">Back</span>
              </motion.h1>
              ...
              >
                <div className="relative">
                  ...
                  <Input
                    ...
                    required
                    className="pl-12 bg-white/5 border-white/5 h-14 rounded-2xl text-white placeholder:text-white/20 focus:border-primary/50 transition-all focus:ring-0"
                  />
                </div>
              </motion.div>
